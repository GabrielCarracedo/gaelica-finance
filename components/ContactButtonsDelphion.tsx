    ...
    <div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      >
        <span style={{ display: 'flex', alignItems: 'center' }}>
          {/* SVG de globo */}
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" viewBox="0 0 24 24">
            <circle cx="12" cy="12" r="10" stroke="#0072C6" strokeWidth="2" fill="#fff"/>
            <path d="M2 12h20M12 2a15.3 15.3 0 0 1 0 20M12 2a15.3 15.3 0 0 0 0 20" stroke="#0072C6" strokeWidth="2"/>
          </svg>
        </span>
        delphion.ai
      </a>
